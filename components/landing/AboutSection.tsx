        ...
        <div className="w-full max-w-6xl mx-auto px-4 py-12 space-y-24">
            ...
            <section className="text-center max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-6 duration-700">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight text-gray-900 leading-[1.05] mb-8">
                    Beyond Keywords.<br />
                    Beyond AI.<br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-blue-600">Resonance.</span>
                </h1>
            ...
            <section className="max-w-4xl mx-auto">
                <div className="bg-white rounded-2xl p-10 md:p-14 border border-gray-100 shadow-sm">
                    <div className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6">Our Position</div>
                    ...
                    <div className="flex flex-wrap gap-4">
                        <span className="px-4 py-2 bg-gray-50 text-gray-700 rounded-lg text-sm font-medium">Seed to Series A Focus</span>
                        <span className="px-4 py-2 bg-gray-50 text-gray-700 rounded-lg text-sm font-medium">Technical Hiring</span>
                        <span className="px-4 py-2 bg-gray-50 text-gray-700 rounded-lg text-sm font-medium">EU 2026 Ready</span>
                    </div>
                </div>
            </section>
            ...
            <section className="space-y-16">
                ...
                <div className="text-center max-w-2xl mx-auto">
                    ...
                    <p className="text-gray-500 text-lg">What sets chime apart from everything else.</p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white rounded-xl p-8 border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all">
                        <div className="w-12 h-12 rounded-lg bg-teal-50 flex items-center justify-center mb-6">
                            <span className="text-teal-600 font-bold text-lg">01</span>
                        </div>
                        ...
                        <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
                            <p>
                                <span className="font-semibold text-gray-900">8 Dimensions of Professional Resonance.</span> Skills, experience,
                    ...
                    <div className="bg-white rounded-xl p-8 border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all">
                        ...
                        <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
                            <p>
                                <span className="font-semibold text-gray-900">Built for EU 2026 Pay Transparency Directive.</span> While others
                    ...
                    <div className="bg-white rounded-xl p-8 border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all">
                        <div className="w-12 h-12 rounded-lg bg-gray-100 flex items-center justify-center mb-6">
                            <span className="text-gray-600 font-bold text-lg">03</span>
                        </div>
                        <h3 className="text-xl font-bold text-gray-900 mb-4">
                            Human-Centric Data
                        </h3>
                        <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
                            <p>
                                <span className="font-semibold text-gray-900">No black box AI.</span> Every match is explainable.
            ...
            <section className="max-w-5xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-500 text-lg">Every match is evaluated across eight weighted dimensions.</p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={dim.name} className="bg-white rounded-xl p-5 border border-gray-100 hover:border-gray-200 transition-colors text-center">
                            <div className="text-2xl font-bold text-teal-600 mb-2">{String(idx + 1).padStart(2, '0')}</div>
                ...
                <div className="bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 rounded-2xl p-12 md:p-16 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <button
                            ...
                            className="bg-white text-gray-900 px-10 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-colors shadow-lg hover:shadow-xl group inline-flex items-center"
                        >
