      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
           ...
           {connections.length === 0 ? (
               <div className="text-gray-500 bg-white p-8 rounded-xl border border-gray-200 text-center">No verified connections yet.</div>
           ) : (
                   ...
                   <div className="flex items-start justify-between">
                       <div className="flex items-center space-x-4">
                           <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center font-bold text-gray-600 text-lg">
                               {conn.avatar ? <img src={conn.avatar} className="w-full h-full rounded-full object-cover"/> : conn.name.charAt(0)}
                           </div>
                           <div>
        ...
        <div className="space-y-4">
           ...
           <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 text-center">
                ...
                <p className="text-sm text-blue-700 mb-6">We can automatically verify colleagues from <span className="font-semibold">Tech Corp</span> and <span className="font-semibold">StartUp Inc</span>.</p>
