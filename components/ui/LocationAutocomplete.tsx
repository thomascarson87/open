    ...
    <div ref={wrapperRef} className={`relative ${className}`}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-10 py-4 bg-gray-50 rounded-2xl border-2 border-transparent focus:border-blue-500/20 focus:bg-white transition-all outline-none font-bold text-gray-800"
        />
        {isLoading && (
      ...
      {showDropdown && results.length > 0 && (
        <div className="absolute z-50 w-full mt-2 bg-white border border-gray-200 rounded-2xl shadow-xl max-h-64 overflow-auto">
          {results.map((result, index) => {
            ...
            return (
              <button
                ...
                className="w-full px-4 py-3 text-left hover:bg-gray-50 flex items-start gap-3 border-b border-gray-100 last:border-b-0 first:rounded-t-2xl last:rounded-b-2xl"
              >
      ...
      {showDropdown && query.length >= 2 && results.length === 0 && !isLoading && (
        <div className="absolute z-50 w-full mt-2 bg-white border border-gray-200 rounded-2xl shadow-xl p-4 text-sm text-gray-500">
