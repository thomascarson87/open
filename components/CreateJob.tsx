                    ...
                    <div className="pt-8 border-t">
                        ...
                        >
                            <div>
                                ...
                                <p className="text-sm text-gray-400 mt-1 text-left">For roles requiring specific credentials or compliance expertise</p>
                            </div>
                                ...
                                {certLoading ? (
                                    ...
                                    <>
                                        ...
                                        <div className="bg-gray-50 p-6 rounded-[2rem] border border-gray-200">
                                            ...
                                            <p className="text-xs text-gray-400 mb-4">Industries where compliance knowledge is critical for this role</p>
