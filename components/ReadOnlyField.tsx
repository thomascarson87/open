...
export const ReadOnlySection: React.FC<ReadOnlySectionProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <div className="p-6 bg-gray-50/50 border border-gray-200 rounded-b-2xl">
...
export const AutoPopulatedBadge: React.FC<AutoPopulatedBadgeProps> = ({
  ...
  <span className={`inline-flex items-center gap-1 px-2 py-0.5 bg-blue-50 text-blue-600 rounded-full text-[10px] font-bold border border-blue-200 ${className}`}>
