...
export default function DevModeSwitcher() {
  ...
  return (
    <div className="fixed bottom-4 left-4 z-[9999]">
      {/* Expanded View */}
      {expanded && (
        <div className="mb-2 bg-white/95 backdrop-blur-sm rounded-xl shadow-xl border border-gray-200 overflow-hidden animate-in slide-in-from-bottom-2 duration-200 w-72 max-h-[80vh] overflow-y-auto">
          ...
          <div className="p-2">
            ...
            {testSignupAccounts.length > 0 && (
              <div className="space-y-1">
                <div className="text-[10px] font-medium text-gray-400 px-1 mb-1">
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors cursor-pointer ${
                        isActive ? 'bg-amber-100' : 'bg-gray-50 hover:bg-gray-100'
                      }`}
                    >
